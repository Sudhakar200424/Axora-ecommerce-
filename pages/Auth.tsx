...
const Auth: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh] bg-offwhite dark:bg-charcoal px-6 transition-colors">
      <div className="w-full max-w-md bg-white dark:bg-clay p-12 shadow-2xl relative">
        ...
        {mode === 'email' && (
          <form className="space-y-6" onSubmit={handleAuth}>
            ...
            <button
              ...
              disabled={loading}
              className="w-full border border-charcoal dark:border-gold text-charcoal dark:text-gold py-4 text-xs font-bold uppercase tracking-[0.2em] hover:bg-neutral-50 dark:hover:bg-gold/10 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
            >
